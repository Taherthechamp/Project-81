...
export default class RideScreen extends Component {
    ...
    handleTransaction = async () => {
       ...
       var transaction_type = await this.checkBikeAvailability(bikeId);
        ...
        if (!transactionType) {
            ...
            Alert.alert("Kindly enter a valid Bike ID")
        ...
        if (bikeRef.docs.length == 0) {
            ...
            bikeRef.docs.map(doc => {
                ...
                if (!doc.data().under_maintenance) {
                    ...
                    transactionType=doc.data().is_bike_available ? "rent" : "return";
